...
They are like a "hybrid secutiry" becaue they behave like debt and equity. They are like debt because they can pay dividends although it may not be required. There are two further subdivisions: cumulative (remember skipped dividends) vs non-cumulative (forget skipped dividends).
...
\item reset preferreds: mix. first fixed then after some time it "resets" to floating.
\end{itemize}
