...
\item scale-invariant pair-wise covariance for all pairs. ie acvf satisfies $\gamma(r,s) = \gamma(r+h, s+h)$. Visually this means the period is constant. ie it doesn't contract and strectch at parts.
\end{itemize}
